      ...
      <Card className="p-6 space-y-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-sm text-muted">{user.designation} · {user.departmentName}</div>
          </div>
        </div>
        <div className="h-px bg-line" />
        <Field label="Authority ID"><Input defaultValue={user.authorityCode} disabled /></Field>
        <Field label="Official email"><Input defaultValue={user.email} disabled /></Field>
        <Field label="Zone"><Input defaultValue={user.zoneName} disabled /></Field>
      </Card>
    </div>
  );
}
